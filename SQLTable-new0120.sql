...
/*更改紀錄:
  有些ID欄位加上 IDENTITY(1,1) 流水號，Customers 表的2個電話號碼改成varchar(50)，
  Users 改成 Customers，多新增兩個表格(#32,#33) email_verifications 和 CartItems
*/
USE storedb
--1
...
CREATE TABLE Coupons (
    ...
    Discount FLOAT NOT NULL, -- 折扣 (% 或 -$)  FLOAT 也可改成 INT (如果是固定整數金額折扣)
...
CREATE TABLE CartItems (
    ...
    CONSTRAINT FK_CartItems_Book FOREIGN KEY (BookID) REFERENCES Book(BookID) ON DELETE CASCADE
);