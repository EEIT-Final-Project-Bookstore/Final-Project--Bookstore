...
public class EcpayFunctions {
	 ...
	 //機器人
	 @Autowired
	 public EcpayFunctions(OrderRepository ordersRepository) {
    ...
    public String buildEcpayForm(String body) {
        ...
        String date = dateFormat.format(order.getOrderCreationTime());
    ...
    private Map<String, String> createEcpayData(String id, String name, String total, String desc, String date) {
        ...
        parameters.put("ClientBackURL", "http://localhost:8080/pages/ecpay/updateStatusOnReturn?MerchantTradeNo=" + id); // 支付成功後用戶跳轉的頁面
