...
public class NotificationsService {
    ...
    public NotificationsBean saveNotification(NotificationsBean notification) {
        ...
        // 强制设置 StatusID 为 10（未读状态）
        StatusBean unreadStatus = statusesRepository.findById(10)
                .orElseThrow(() -> new IllegalArgumentException("StatusID 10 (未读状态) 不存在！"));
    ...
    public void markAllAsRead(int customerID) {
        // 获取状态 ID 为 11（已读）的状态
        StatusBean readStatus = statusesRepository.findById(11)
