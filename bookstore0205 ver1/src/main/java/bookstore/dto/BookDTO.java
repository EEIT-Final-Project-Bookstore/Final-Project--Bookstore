...
public class BookDTO {
    ...
    private String authorName; 			// 🔹 新增：作者名稱
    
    private Integer publisherId;        // 出版社ID
    private String publisherName; 		// 🔹 新增：出版社名稱
    
    private Integer languageId;         // 語言ID
    
    private Integer subcategoryId;      // 子分類ID
    private String subcategoryName; 	// 🔹 新增：子分類名稱
    private String categoryName; 		// 🔹 新增：分類名稱（從 SubcategoryBean 取出）
    ...
    private Date lastUpdated;           // 最後更新時間
    private Date publishDate;           // 出版日期
    
    private String imageUrl;            // 圖片URL
    private String imageDescription;    // 圖片描述
