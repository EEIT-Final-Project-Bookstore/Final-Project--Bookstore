            ...
            <ul>
              <li v-if="authStore.isAuthenticated">
                <span class="user-admin-name">
                  ...
                  >
                  <span v-else-if="authStore.customerName"
                    >{{ authStore.customerName }}</span
                  >
                </span>
      ...
      <div v-if="isModalOpen" class="modal-overlay">
        <div class="modal">
          <div class="modal-header">
            <h3>系統通知</h3>
            <button @click="markAllAsRead" class="mark-all-read-button">
              全部已讀
            </button>
          </div>
      ...
      <footer class="site-footer">
        <div class="footer-container">
          ...
          <div class="footer-section">
            <h3>關於我們</h3>
            <p>
              我們致力於打造一個舒適且便利的購物體驗，讓用戶能夠快速瀏覽、
              搜尋、下單，並透過書評分享與交流進一步探索各種書籍的魅力。
            </p>
          </div>
