...
public class CouponService {
    ...
    // List<CouponOwnershipBean> ownerships =
    // couponOwnershipRepository.findByCustomerCustomerID(customerID);
    //
    ...
    // "Coupon: " + coupon.getCouponCode() + " valid until " +
    // coupon.getEndDate().format(formatter));
